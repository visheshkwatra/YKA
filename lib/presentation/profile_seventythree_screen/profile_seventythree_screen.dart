import 'bloc/profile_seventythree_bloc.dart';
import 'models/profile_seventythree_model.dart';
...
class ProfileSeventythreeScreen extends StatelessWidget {
  const ProfileSeventythreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileSeventythreeBloc>(
      create: (context) => ProfileSeventythreeBloc(ProfileSeventythreeState(
        profileSeventythreeModelObj: ProfileSeventythreeModel(),
      ))
        ..add(ProfileSeventythreeInitialEvent()),
      child: ProfileSeventythreeScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ProfileSeventythreeBloc, ProfileSeventythreeState>(
