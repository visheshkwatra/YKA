import 'bloc/profile_sixtyfive_bloc.dart';
import 'models/profile_sixtyfive_model.dart';
...
class ProfileSixtyfiveBottomsheet extends StatelessWidget {
  const ProfileSixtyfiveBottomsheet({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileSixtyfiveBloc>(
      create: (context) => ProfileSixtyfiveBloc(ProfileSixtyfiveState(
        profileSixtyfiveModelObj: ProfileSixtyfiveModel(),
      ))
        ..add(ProfileSixtyfiveInitialEvent()),
      child: ProfileSixtyfiveBottomsheet(),
    );
  }
