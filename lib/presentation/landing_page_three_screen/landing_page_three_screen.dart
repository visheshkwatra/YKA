import 'bloc/landing_page_three_bloc.dart';
import 'models/landing_page_three_model.dart';
...
class LandingPageThreeScreen extends StatelessWidget {
  const LandingPageThreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<LandingPageThreeBloc>(
      create: (context) => LandingPageThreeBloc(LandingPageThreeState(
        landingPageThreeModelObj: LandingPageThreeModel(),
      ))
        ..add(LandingPageThreeInitialEvent()),
      child: LandingPageThreeScreen(),
    );
  }
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ...
              _buildLandingPageThree(context),
              SizedBox(height: 5.v),
            ],
          ),
        ),
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            CustomImageView(
              imagePath: ImageConstant.imgEllipse30886,
              height: 247.v,
              width: 393.h,
              alignment: Alignment.bottomCenter,
            ),
  ...
  /// Section Widget
  Widget _buildLandingPageThree(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          BlocBuilder<LandingPageThreeBloc, LandingPageThreeState>(
          ...
          BlocSelector<LandingPageThreeBloc, LandingPageThreeState,
