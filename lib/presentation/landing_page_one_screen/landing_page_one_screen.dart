import 'bloc/landing_page_one_bloc.dart';
import 'models/landing_page_one_model.dart';
...
class LandingPageOneScreen extends StatelessWidget {
  const LandingPageOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<LandingPageOneBloc>(
      create: (context) => LandingPageOneBloc(LandingPageOneState(
        landingPageOneModelObj: LandingPageOneModel(),
      ))
        ..add(LandingPageOneInitialEvent()),
      child: LandingPageOneScreen(),
    );
  }
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            CustomImageView(
              imagePath: ImageConstant.imgEllipse30881,
              height: 247.v,
              width: 393.h,
              alignment: Alignment.bottomCenter,
            ),
  ...
  /// Section Widget
  Widget _buildLandingPageOne(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          BlocBuilder<LandingPageOneBloc, LandingPageOneState>(
          ...
          BlocSelector<LandingPageOneBloc, LandingPageOneState,
