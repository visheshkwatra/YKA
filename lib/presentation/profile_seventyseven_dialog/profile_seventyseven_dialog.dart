import 'bloc/profile_seventyseven_bloc.dart';
import 'models/profile_seventyseven_model.dart';
import 'package:flutter/material.dart';
import 'package:yka_app/core/app_export.dart';
import 'package:yka_app/widgets/custom_elevated_button.dart';

// ignore_for_file: must_be_immutable
class ProfileSeventysevenDialog extends StatelessWidget {
  const ProfileSeventysevenDialog({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileSeventysevenBloc>(
      create: (context) => ProfileSeventysevenBloc(ProfileSeventysevenState(
        profileSeventysevenModelObj: ProfileSeventysevenModel(),
      ))
        ..add(ProfileSeventysevenInitialEvent()),
      child: ProfileSeventysevenDialog(),
    );
  }
