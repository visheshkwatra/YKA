import 'bloc/profile_seventyfour_bloc.dart';
import 'models/profile_seventyfour_model.dart';
...
class ProfileSeventyfourScreen extends StatelessWidget {
  ProfileSeventyfourScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileSeventyfourBloc>(
      create: (context) => ProfileSeventyfourBloc(ProfileSeventyfourState(
        profileSeventyfourModelObj: ProfileSeventyfourModel(),
      ))
        ..add(ProfileSeventyfourInitialEvent()),
      child: ProfileSeventyfourScreen(),
    );
  }
  ...
  Widget _buildFloatingTextField(BuildContext context) {
    return BlocSelector<ProfileSeventyfourBloc, ProfileSeventyfourState,
  ...
  Widget _buildPhoneNumber(BuildContext context) {
    return BlocBuilder<ProfileSeventyfourBloc, ProfileSeventyfourState>(
