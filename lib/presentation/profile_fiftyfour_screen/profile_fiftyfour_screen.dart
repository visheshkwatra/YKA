import 'bloc/profile_fiftyfour_bloc.dart';
import 'models/profile_fiftyfour_model.dart';
...
class ProfileFiftyfourScreen extends StatelessWidget {
  const ProfileFiftyfourScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileFiftyfourBloc>(
      create: (context) => ProfileFiftyfourBloc(ProfileFiftyfourState(
        profileFiftyfourModelObj: ProfileFiftyfourModel(),
      ))
        ..add(ProfileFiftyfourInitialEvent()),
      child: ProfileFiftyfourScreen(),
    );
  }
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Spacer(),
                    BlocSelector<ProfileFiftyfourBloc, ProfileFiftyfourState,
                        bool?>(
