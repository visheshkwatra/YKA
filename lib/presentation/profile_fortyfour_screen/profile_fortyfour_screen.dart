import 'bloc/profile_fortyfour_bloc.dart';
import 'models/profile_fortyfour_model.dart';
...
class ProfileFortyfourScreen extends StatelessWidget {
  const ProfileFortyfourScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileFortyfourBloc>(
      create: (context) => ProfileFortyfourBloc(ProfileFortyfourState(
        profileFortyfourModelObj: ProfileFortyfourModel(),
      ))
        ..add(ProfileFortyfourInitialEvent()),
      child: ProfileFortyfourScreen(),
    );
  }
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ...
              _buildProfileFortyFour(context),
            ],
          ),
        ),
      ),
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            CustomImageView(
              imagePath: ImageConstant.imgEllipse30883,
              height: 247.v,
              width: 393.h,
              alignment: Alignment.bottomCenter,
            ),
  ...
  /// Section Widget
  Widget _buildProfileFortyFour(BuildContext context) {
    return Column(
      children: [
        Align(
        ...
        Padding(
          ...
          child: BlocBuilder<ProfileFortyfourBloc, ProfileFortyfourState>(
        ...
        Padding(
          ...
          child: BlocSelector<ProfileFortyfourBloc, ProfileFortyfourState,
