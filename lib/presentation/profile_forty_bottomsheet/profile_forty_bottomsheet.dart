import 'bloc/profile_forty_bloc.dart';
import 'models/profile_forty_model.dart';
...
class ProfileFortyBottomsheet extends StatelessWidget {
  const ProfileFortyBottomsheet({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileFortyBloc>(
      create: (context) => ProfileFortyBloc(ProfileFortyState(
        profileFortyModelObj: ProfileFortyModel(),
      ))
        ..add(ProfileFortyInitialEvent()),
      child: ProfileFortyBottomsheet(),
    );
  }
