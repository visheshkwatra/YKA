import 'bloc/profile_sixtythree_bloc.dart';
import 'models/profile_sixtythree_model.dart';
...
class ProfileSixtythreeScreen extends StatelessWidget {
  const ProfileSixtythreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileSixtythreeBloc>(
      create: (context) => ProfileSixtythreeBloc(ProfileSixtythreeState(
        profileSixtythreeModelObj: ProfileSixtythreeModel(),
      ))
        ..add(ProfileSixtythreeInitialEvent()),
      child: ProfileSixtythreeScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ProfileSixtythreeBloc, ProfileSixtythreeState>(
