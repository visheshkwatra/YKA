import 'bloc/profile_twentyseven_bloc.dart';
import 'models/profile_twentyseven_model.dart';
...
class ProfileTwentysevenScreen extends StatelessWidget {
  const ProfileTwentysevenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileTwentysevenBloc>(
      create: (context) => ProfileTwentysevenBloc(ProfileTwentysevenState(
        profileTwentysevenModelObj: ProfileTwentysevenModel(),
      ))
        ..add(ProfileTwentysevenInitialEvent()),
      child: ProfileTwentysevenScreen(),
    );
  }
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ...
              _buildProfileTwentySeven(context),
            ],
          ),
        ),
      ),
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            CustomImageView(
              imagePath: ImageConstant.imgEllipse30887,
              height: 247.v,
              width: 393.h,
              alignment: Alignment.bottomCenter,
            ),
  ...
  /// Section Widget
  Widget _buildProfileTwentySeven(BuildContext context) {
    return Column(
      children: [
        Align(
        ...
        Padding(
          ...
          child: BlocBuilder<ProfileTwentysevenBloc, ProfileTwentysevenState>(
        ...
        Padding(
          ...
          child: BlocSelector<ProfileTwentysevenBloc, ProfileTwentysevenState,
