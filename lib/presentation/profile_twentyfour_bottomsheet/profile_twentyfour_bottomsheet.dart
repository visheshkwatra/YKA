import 'bloc/profile_twentyfour_bloc.dart';
import 'models/profile_twentyfour_model.dart';
...
class ProfileTwentyfourBottomsheet extends StatelessWidget {
  const ProfileTwentyfourBottomsheet({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileTwentyfourBloc>(
      create: (context) => ProfileTwentyfourBloc(ProfileTwentyfourState(
        profileTwentyfourModelObj: ProfileTwentyfourModel(),
      ))
        ..add(ProfileTwentyfourInitialEvent()),
      child: ProfileTwentyfourBottomsheet(),
    );
  }
